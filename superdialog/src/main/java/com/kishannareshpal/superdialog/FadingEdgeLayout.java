...
/*
 * All credits goes to https://github.com/bosphere/Android-FadingEdgeLayout
 *
 * This Edit by Kishan Nareshpal Jadav includes:
 *  – The fading color, from black to grey.
 */
public class FadingEdgeLayout extends FrameLayout {
    ...
    private static final int[] FADE_COLORS = new int[]{Color.TRANSPARENT, Color.parseColor("#EEEEEE")};
    private static final int[] FADE_COLORS_REVERSE = new int[]{Color.parseColor("#EEEEEE"), Color.TRANSPARENT};
